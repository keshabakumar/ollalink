...
const jwksPath = join(import.meta.dirname, "..", "archive", "convex-ready-template-main", "convex-ready-template-main", "tmp", "jwks");
const jwksValue = readFileSync(jwksPath, "utf-8").trim();
console.log("JWKS value to set:\n", jwksValue, "\n");

const backendDir = join(import.meta.dirname, "..", "archive", "convex-ready-template-main", "convex-ready-template-main", "packages", "backend");
