...
$v = (Get-Content -Raw 'D:\ollalink\convex-ready-template-main\convex-ready-template-main\tmp\jwks').Trim()
Write-Host "JWKS value: $v"

Set-Location 'D:\ollalink\convex-ready-template-main\convex-ready-template-main\packages\backend'
