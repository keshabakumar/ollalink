...
cp /tmp/sessions-card.tsx /opt/ollalink/apps/app/src/components/sessions-card.tsx
cp /tmp/settings_page.tsx "/opt/ollalink/apps/app/src/app/[locale]/(dashboard)/settings/page.tsx"
